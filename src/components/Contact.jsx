              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <p className="text-[#666]">07717411855</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <p className="text-[#666]">Info@therecoveryrooms.uk</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <p className="text-[#666]">Unit 1A, Acton Street, Long Eaton, Nottingham NG10 1FT. </p>
                  </div>
                </div>
